...
const AppBar: React.FC<AppBarProps> = ({ onToggleTheme, isDarkMode }) => {
  const logoLightUrl = new URL("../assets/images/logo.svg", import.meta.url)
    .href;
  const logoDarkUrl = new URL("../assets/images/logo-dark.svg", import.meta.url)
    .href;
  ...
  return (
    <header className="mb-2 flex items-center justify-between rounded-xl border border-gray-300 bg-white px-3 py-2 shadow dark:border-0 dark:bg-neutral-800">
      ...
      <div className="rounded-xl border border-transparent p-px focus:border-red-700">
        <button
